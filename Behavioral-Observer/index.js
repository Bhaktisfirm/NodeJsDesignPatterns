...
/**
 * wen we subscribe objects in catsandthings it means that that object
 * can listen to an anouncement of a new sales. All types of objects can
 * subscribe shopper and mall !
 */
